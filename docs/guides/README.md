...
| **[5. Stacking, Z-Index & Grouping](05-stacking-zindex.md)**              | Managing z-index depth, CSS stacking context gotchas, multi-zone groups, and top-most card activation.              | `usePopoverZIndex`, `usePopoverIsTopMost`, Stacking Context Traps             |
