...
export default {
  meta: {
    ...
    docs: {
      description:
        'Ensure setPointerCapture calls have corresponding releasePointerCapture handlers',
      category: 'Gestures & Pointer',
      recommended: true,
    },
    schema: [],
    messages: {
      unreleasedPointerCapture:
        'Element with setPointerCapture should release pointer capture on pointerup/pointercancel.',
    },
  },
  create(context) {
    return {
