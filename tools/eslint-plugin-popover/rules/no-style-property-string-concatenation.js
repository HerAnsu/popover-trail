...
export default {
  meta: {
    ...
    docs: {
      description:
        'Encourage structured vector transform helper functions over manual matrix string concatenation.',
    ...
    messages: {
      useMatrixHelper:
        'Avoid raw string interpolation for {{ matrix }}; use buildMatrix3DTransform() helper.',
    },
  },
  create(context) {
