...
export default {
  meta: {
    ...
    docs: {
      description:
        'Encourage passing plain serializable objects in store action payloads instead of live DOM elements.',
      category: 'Store Safety',
      recommended: true,
    },
    schema: [],
    messages: {
      suggestSerializablePayload:
        'Avoid passing raw HTMLElement in action payload {{ name }}; pass element key or bounds.',
    },
  },
  create(context) {
