...
export default {
  meta: {
    ...
    docs: {
      description:
        'Encourage cleaning up signal.addEventListener("abort") listeners upon async completion.',
      category: 'Memory',
      recommended: true,
    },
    schema: [],
    messages: {
      suggestSignalCleanup:
        'Abort listener attached in {{ name }} without corresponding removeEventListener in finally block.',
    },
  },
  create(context) {
