...
export default {
  meta: {
    ...
    docs: {
      description:
        'Recommend returning ReadonlyMap instead of mutable Map from selector functions.',
    ...
    messages: {
      useReadonlyMap:
        'Return type of selector {{ name }} should be ReadonlyMap/ReadonlySet to prevent external mutations.',
    },
  },
  create(context) {
