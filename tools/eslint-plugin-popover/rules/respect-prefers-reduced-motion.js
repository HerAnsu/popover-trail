...
export default {
  meta: {
    ...
    docs: {
      description:
        'Ensure spring and keyframe animations respect prefers-reduced-motion user preferences',
    ...
    messages: {
      respectReducedMotion:
        'Ensure animation presets disable or reduce duration when prefers-reduced-motion is matched.',
    },
  },
  create(context) {
