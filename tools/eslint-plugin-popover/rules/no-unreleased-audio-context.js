...
export default {
  meta: {
    ...
    docs: {
      description:
        'Enforce audioContext.close() in cleanup functions to prevent background audio driver thread leaks.',
      category: 'Memory',
      recommended: true,
    },
    schema: [],
    messages: {
      requireAudioClose:
        'AudioContext created in {{ name }} must be closed with ctx.close() on cleanup.',
    },
  },
  create(context) {
