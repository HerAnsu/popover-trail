...
export default {
  meta: {
    ...
    docs: {
      description:
        'Use event.composedPath() in outside click handlers to support Shadow DOM and Web Components',
    ...
    messages: {
      useComposedPath:
        'Use `e.composedPath ? e.composedPath() : ...` to ensure outside click logic traverses Shadow DOM boundaries.',
    },
  },
  create(context) {
