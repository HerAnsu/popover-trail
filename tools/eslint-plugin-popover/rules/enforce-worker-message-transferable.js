...
export default {
  meta: {
    ...
    docs: {
      description:
        'Recommend passing Transferable buffers in postMessage second argument for zero-copy IPC.',
    ...
    messages: {
      suggestTransferable:
        'Passing ArrayBuffer to worker.postMessage without transfer list; add transfer list for zero-copy IPC.',
    },
  },
  create(context) {
