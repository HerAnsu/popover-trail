...
export default {
  meta: {
    type: 'suggestion',
    docs: {
      description: 'Recommend checking buffer.detached when reading from buffers that might have been transferred.',
      category: 'Memory',
      recommended: true,
    },
    schema: [],
    messages: {
      checkDetachedBuffer: 'ArrayBuffer in {{ name }} might be detached after postMessage; check byteLength > 0.',
    },
  },
  create(context) {
