...
export default {
  meta: {
    ...
    docs: {
      description:
        'Ensure canvas and connector lines adapt to devicePixelRatio for retina crispness',
    ...
    messages: {
      dprScaling:
        'Scale trail connection lines with window.devicePixelRatio to prevent blurry edges on HiDPI screens.',
    },
  },
  create(context) {
    return {
