...
export default {
  meta: {
    ...
    docs: {
      description:
        'Ensure will-change CSS properties are removed after gesture/transition finishes',
    ...
    messages: {
      willChangeCleanup:
        'Reset willChange to "auto" when card transition completes to free GPU memory.',
    },
  },
  create(context) {
    return {
