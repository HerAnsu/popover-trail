...
export default {
  meta: {
    ...
    docs: {
      description:
        'Disallow reading layout properties like offsetHeight or getBoundingClientRect in loops to avoid layout thrashing.',
      category: 'Performance',
      recommended: true,
    },
    schema: [],
    messages: {
      noForcedReflowInLoop:
        'Reading layout property {{ prop }} inside a loop triggers forced synchronous reflow.',
    },
  },
  create(context) {
