...
export default {
  meta: {
    ...
    docs: {
      description:
        'Encourage inert attribute on background elements when modal popovers are active',
    ...
    messages: {
      suggestInert:
        'Consider applying inert to background root elements during modal popover presentation.',
    },
  },
  create(context) {
    return {
