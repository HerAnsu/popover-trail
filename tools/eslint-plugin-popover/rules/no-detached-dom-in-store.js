...
export default {
  meta: {
    ...
    docs: {
      description:
        'Disallow storing raw HTMLElement or DOM references directly in persistent store state',
    ...
    messages: {
      domInStore:
        'Do not store raw HTMLElement references in persistent store state. Store rects or string IDs instead.',
    },
  },
  create(context) {
