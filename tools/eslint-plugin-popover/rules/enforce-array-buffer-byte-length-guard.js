...
export default {
  meta: {
    ...
    docs: {
      description:
        'Recommend checking buffer.byteLength before creating DataView or TypedArray instances.',
      category: 'Memory',
      recommended: true,
    },
    schema: [],
    messages: {
      checkByteLength:
        'Function {{ name }} creates TypedArray view without checking buffer.byteLength > 0.',
    },
  },
  create(context) {
